...
const About: React.FC = () => (
  <Box
    sx={{
      background: 'linear-gradient(135deg, #1e1e1e, #111)', // Sleek dark gradient background
      minHeight: '100vh',
      padding: '50px',
      display: 'flex',
  ...
  >
    <Paper
      elevation={3}
      sx={{
        backgroundColor: 'rgba(255, 255, 255, 0.1)', // Semi-transparent background for the paper
        backdropFilter: 'blur(10px)', // Blur effect for the cool, modern look
        padding: 4,
        maxWidth: '800px',
        color: 'white',
      }}
